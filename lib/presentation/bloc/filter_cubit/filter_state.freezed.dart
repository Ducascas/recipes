...
mixin _$FilterState {
 ...
 ImageFilterType? get imageType; int? get maxMinutes;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FilterState&&(identical(other.imageType, imageType) || other.imageType == imageType)&&(identical(other.maxMinutes, maxMinutes) || other.maxMinutes == maxMinutes));
}


@override
int get hashCode => Object.hash(runtimeType,imageType,maxMinutes);

@override
String toString() {
  return 'FilterState(imageType: $imageType, maxMinutes: $maxMinutes)';
}
...
@useResult
$Res call({
 ImageFilterType? imageType, int? maxMinutes
});
...
/// Create a copy of FilterState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? imageType = freezed,Object? maxMinutes = freezed,}) {
  return _then(_self.copyWith(
imageType: freezed == imageType ? _self.imageType : imageType // ignore: cast_nullable_to_non_nullable
as ImageFilterType?,maxMinutes: freezed == maxMinutes ? _self.maxMinutes : maxMinutes // ignore: cast_nullable_to_non_nullable
as int?,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( ImageFilterType? imageType,  int? maxMinutes)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _FilterState() when $default != null:
return $default(_that.imageType,_that.maxMinutes);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( ImageFilterType? imageType,  int? maxMinutes)  $default,) {final _that = this;
switch (_that) {
case _FilterState():
return $default(_that.imageType,_that.maxMinutes);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( ImageFilterType? imageType,  int? maxMinutes)?  $default,) {final _that = this;
switch (_that) {
case _FilterState() when $default != null:
return $default(_that.imageType,_that.maxMinutes);case _:
  return null;
...
class _FilterState implements FilterState {
  const _FilterState({this.imageType, this.maxMinutes});
  

@override final  ImageFilterType? imageType;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _FilterState&&(identical(other.imageType, imageType) || other.imageType == imageType)&&(identical(other.maxMinutes, maxMinutes) || other.maxMinutes == maxMinutes));
}
...
/// Create a copy of FilterState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? imageType = freezed,Object? maxMinutes = freezed,}) {
